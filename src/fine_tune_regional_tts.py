...
from TTS.vocoder.utils.generic_utils import load_checkpoint
...
output_path = "models/fine_tuned_regional_model/"
...
for epoch in range(epochs):
    ...
    for batch in dataset_loader(batch_size, "data/regional_language_dataset.csv"):
        model.train()
        loss = model(batch)
        loss.backward()
        optimizer.step()
